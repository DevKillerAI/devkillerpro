-- Explicit operator application only. This file never modifies v1/app schemas.
begin;
...
-- Preserve configured amounts while allowing explicit Workbench ceilings beyond the pilot default.
